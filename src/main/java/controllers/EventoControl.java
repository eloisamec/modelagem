...
public class EventoControl {
	...
	private double tempoTotalSimulacao; // tempo total de duracao da simulacao
										// em segundos
	private Long eventId; // id do mais novo evento

	private double probEntreChegadaC1; // parametro para a funcao exponencial de
										// chegade da celula 2
	private double probEntreChegadaC2; // parametro para a funcao exponencial de
										// chegade da celula 2
	...
	private List<Evento> createEvento() {
		...
		if (tpChamada == models.enums.TipoChamada.C1C1 || tpChamada == models.enums.TipoChamada.C2C2) {
